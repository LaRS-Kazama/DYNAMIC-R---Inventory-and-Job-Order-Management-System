...
public class ProductionJobOrderDashboard extends BaseForm {
    public ProductionJobOrderDashboard(){
        super("DYNAMIC R PRODUCTION FOREMAN DASHBOARD");
    ...
    private void initComponents() {
        ...
        contentPanel.add(new ProductionJobOrderPanel(), BorderLayout.CENTER);
