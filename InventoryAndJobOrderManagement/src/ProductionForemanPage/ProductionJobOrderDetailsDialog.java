...
public class ProductionJobOrderDetailsDialog extends JDialog {

    private JTable table;
    private int rowIndex;

    public ProductionJobOrderDetailsDialog(JFrame parent, JTable orderTable, int row) {
        ...
        // ===== PROGRESS NOTES =====
        JPanel notesPanel = createSection("Progress Notes", 30, y, 640, 180);
        add(notesPanel);

        addTextAreaRow(notesPanel, "Notes:", getTableValue(row, 6), 20, 30);

        // ===== CLOSE BUTTON =====
        JButton btnClose = new JButton("Close");
        btnClose.setBounds(270, 520, 160, 40);
